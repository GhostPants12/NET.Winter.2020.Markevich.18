...
namespace Events.Task1
{
    public class WeatherData
    {
        ...
        /// <summary>Occurs when [weather data changed].</summary>
        ...
        public void RandomizeWeatherData()
        {
            ...
            this.WeatherDataChanged?.Invoke(this, new WeatherDataChangedEventArgs(this.Temperature, this.Humidity, this.Pressure));
        }
    }
}
